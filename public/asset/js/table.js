    ...
    (function (a, b, c) {
      ...
      (a.fn.validateOnBlur = function (b, c) {
        ...
        (a.fn.validateInputOnBlur = function (c, d, e, f) {
          if (
            ((a.formUtils.eventType = f), this.willPostponeValidation())
          ) {
            var g = this,
                ...
                a('script[src*="form-validator"]').each(function () {
                  return (
                    (c =
                      this.src.substr(
                        0,
                        this.src.lastIndexOf("index.html")
                      ) + "/"),
                    "/" === c && (c = ""),
                    !1
                  );
...
var no_image_placeholder =
"../theme.hstatic.net/200000295082/1000772075/14/no_imagec353.jpg?v=586";
