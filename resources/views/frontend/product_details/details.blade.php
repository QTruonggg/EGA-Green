    ...
    <div class="container card py-2">
      <div class="section wrap-padding-15 wp_product_main">
        <div class="details-product section">
          <div class="row">
            <div
              class="product-detail-left product-images col-xs-12 col-sm-12 col-md-8 mx-auto col-lg-5"
            >
                ...
                <div class="col-12 col-md-7">
                  <div class="group-status">
                    <span class="first_status"
                      >Thương hiệu:<span class="status_name"> Khác </span>
                  ...
                  <div class="price-box">
                    <span class="special-price"
                      ><span class="price product-price">{{$product->salePrice}}₫</span>
                    </span>
                    <!-- Giá Khuyến mại -->
                  ...
                  >
                    <div class="ega-container">
                      <div
                        class="flashsale__header d-flex justify-content-between"
                      >
                      ...
                      <div class="flashsale__product">
                        <div
                          class="flashsale__item"
                          data-pd-id="1031063938"
                          data-inventory-quantity="10"
                          data-sold-quantity="1016"
                          data-management="true"
                          data-available="true"
                          data-max-stock="300"
                        >
                          <div
                            class="flashsale__bottom"
                            style="display: none"
                          >
                  ...
                  <script
                    src="../../theme.hstatic.net/200000295082/1000772075/14/flashsalec353.js?v=586"
                    defer
                  ></script>
                  ...
                  <div class="bottom-cart px-md-0">
                    <div class="back-index">
                      <div class="gift-list">
                        <label class="h5"
                          ><i class="fas fa-gift mr-2"></i> Siêu Ưu
                          Đãi</label
                        >
                        <ul class="free-gifts">
                          <li class="mb-3">
                            <span class="align-items-baseline">
                              <span class="mb-2"
                                >Nhập mã <b>EGAGREEN</b> để được giảm 5% sản
                                phẩm thương hiệu EGA Green
                                <button
                                  class="btn p-1 mb-1 btn-sm js-copy"
                                  data-copy="EGAGREEN"
                                >
                                  Sao chép
                                </button>
                          ...
                          <li class="mb-3">
                            <span class="align-items-baseline">
                              <span class="mb-2"
                                >Nhập mã <b>EGANY</b> để được giảm 15% tổng
                  ...
                  >
                    <div class="form-product w-100">
                      <div class="box-variant clearfix">
                        <input type="hidden" name="id" value="1068141226" />
                      </div>
