    ...
    <div class="col-md-9">
        <div class="card">
            ...
            <div class="card-body p-0">
                <form action="{{$category_detail->id}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card card-primary">
                                ...
                                <div class="card-body">
                                    <div class="form-group mt-1 mb-1">
                                        ...
                                        <input type="text" id="name" name="name" value="{{$category_detail->name}}" class="form-control" placeholder="Nhập tên">
                                    </div>
         
                                    <input type="hidden" name="image"  value="{{$category_detail->image}}">
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="card-body">
                <div id="imgList" 
                    style="
                        ...
                        margin-bottom: 20px;
                    ">
                    <img style="width:100%; height:100%; border-radius:50%; object-fit:cover;" id="img_category" src="{{$category_detail->image}}"  alt="..">
                </div>
        ...
        CKFinder.modal( {
            ...
            onInit: function( finder ) {
                finder.on( 'files:choose', function( evt ) {
                    ...
                    var img = document.getElementById('img_category')
