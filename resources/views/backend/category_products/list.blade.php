    ...
    <div class="card-header">
        <div class="btn-group">
            <table>
                <tbody>
                <tr>
                    <form method="get" action="{{route('admin.category_products.search')}}">
                        <td>
                        ...
                        <td><a class="btn btn-secondary" href="{{route('admin.category_products')}}">Xóa tìm kiếm</a></td>
                    </form>
                </tr>
            </tbody>
        </table>
        ...
        <div class="dt-buttons btn-group">
            <a href="{{route('admin.createCategory_products')}}" class="btn btn-secondary action-item" tabindex="0" aria-controls="table-categories">
                <span>
                ...
                <tbody>
                    ...
                    <tr id="row" class="text-center">
                        ...
                        <td class="project-actions text-right">
                            <a href="{{route('admin.getUpdateCategory_products',[$item->id])}}" class="btn btn-sm btn-icon">
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer justify-content-center">
                                    ...
                                    <a href="{{route('admin.deleteCategory_products',[$item->id])}}"  type="button" class="btn btn-danger">Xóa</a>
                                </div>
                            </div>
                        </div>
                    </div>
