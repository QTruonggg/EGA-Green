    ...
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="card-body p-0">
                ...
                <form id="cerfitication" action="{{route('admin.updateCategory_products',$category_product->id)}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card card-primary">
                                ...
                                <div class="card-body">
                                    <div class="form-group mt-1 mb-1">
                                        ...
                                        <input type="text" id="name" name="name" value="{{$category_product->name}}" class="form-control" placeholder="Nhập tên">
                                        @error('name')
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group mt-1 mb-1">
                                                ...
                                                <input type="text" id="seo_keyword" name="seo_keyword" value="{{$category_product->seo_keyword}}" class="form-control">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group mt-1 mb-1">
                                                ...
                                                <input type="text" id="seo_description" name="seo_description" value="{{$category_product->seo_description}}" class="form-control">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group mt-1 mb-1">
                                                ...
                                                <input type="text" id="seo_title" name="seo_title" value="{{$category_product->seo_title}}" class="form-control">
                    ...
                    <div class="row">
                        <div class="col-12  ps-5 mb-2">
                            <a href="{{route('admin.category_products')}}" class="btn btn-secondary">Quay lại</a>
