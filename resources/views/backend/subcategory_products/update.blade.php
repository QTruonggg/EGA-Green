    ...
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="card-body p-0">
                ...
                <form id="cerfitication" action="{{route('admin.updateSubcategory',[$subcategory_products->id])}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card card-primary">
                                ...
                                <div class="card-body">
                                    <div class="form-group mt-1 mb-1">
                                        ...
                                        <input type="text" id="name" name="name" value="{{$subcategory_products->name}}" class="form-control" placeholder="Nhập tên">
                                        @error('name')
                                        <span class="text-danger mt-1 d-block">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    <div class="form-group mt-1 mb-1">
                                        <label for="category_id" class="form-label mb-1">Danh mục sản phẩm</label>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group mt-1 mb-1">
                                                ...
                                                <input type="text" id="seo_keyword" name="seo_keyword" value="{{$subcategory_products->seo_keyword}}" class="form-control">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group mt-1 mb-1">
                                                ...
                                                <input type="text" id="seo_description" name="seo_description" value="{{$subcategory_products->seo_description}}" class="form-control">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group mt-1 mb-1">
                                                ...
                                                <input type="text" id="seo_title" name="seo_title" value="{{$subcategory_products->seo_title}}" class="form-control">
                    ...
                    <div class="row">
                        <div class="col-12  ps-5 mb-2">
                            <a href="{{route('admin.Subcategory')}}" class="btn btn-secondary">Quay lại</a>
