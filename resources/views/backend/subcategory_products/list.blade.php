...
<div class="card">
    <div class="card-header">
            ...
            <table>
                ...
                <tr>
                    <form method="get" action="{{route('admin.subcategory.search')}}">
                        ...
                        <td><a class="btn btn-secondary" href="{{route('admin.Subcategory')}}">Xóa tìm kiếm</a></td>
                    </form>
                </tr>
            </tbody>
        </table>
        ...
        <div class="dt-buttons btn-group">
            <a href="{{route('admin.createSubcategory')}}" class="btn btn-secondary action-item" tabindex="0" aria-controls="table-categories">
                <span>
    ...
    <div class="card-body p-0">
        <div class="table-responsive-xl">
            <table class="table table-striped projects">
                ...
                <tbody>
                    @foreach($subcategories_products as $item)
                    <tr id="row" class="text-center">
                        ...
                        <td class="project-actions text-right">
                            <a href="{{route('admin.getUpdateSubcategory',[$item->id])}}" class="btn btn-sm btn-icon">
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer justify-content-center">
                                    ...
                                    <a href="{{route('admin.deleteSubcategory',[$item->id])}}"  type="button" class="btn btn-danger">Xóa</a>
                                </div>
                            </div>
                        </div>
                    </div>
